...
import org.carbon.device.DeviceSettings.FileUtils;
import org.carbon.device.DeviceSettings.doze.DozeSettingsActivity;
import org.carbon.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.carbon.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.carbon.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.carbon.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.carbon.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
