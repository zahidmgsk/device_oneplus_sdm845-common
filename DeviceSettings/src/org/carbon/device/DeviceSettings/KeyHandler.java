...
import org.carbon.device.DeviceSettings.DeviceSettings;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public static final String CLIENT_PACKAGE_PATH = "/data/misc/carbon/client_package_name";
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("org.carbon.device.DeviceSettings",
