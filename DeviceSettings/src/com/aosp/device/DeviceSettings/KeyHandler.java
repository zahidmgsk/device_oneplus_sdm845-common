...
import com.aosp.device.DeviceSettings.DeviceSettings;
import com.aosp.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.aosp.device.DeviceSettings",
