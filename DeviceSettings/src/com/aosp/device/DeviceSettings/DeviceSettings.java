...
import com.aosp.device.DeviceSettings.FileUtils;
import com.aosp.device.DeviceSettings.doze.DozeSettingsActivity;
import com.aosp.device.DeviceSettings.preferences.ProperSeekBarPreference;
import com.aosp.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import com.aosp.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import com.aosp.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.aosp.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
